...
const styles = StyleSheet.create({
  ...
  inputExercise: {flex: 2,borderWidth: 1,borderColor: '#ddd',borderRadius: 8,paddingVertical: 10,paddingHorizontal: 14,marginRight: 12,fontSize: 15,backgroundColor: '#f5f5f5',},
  inputSmall: {flex: 1,borderWidth: 1,borderColor: '#ddd',borderRadius: 8,paddingVertical: 10,paddingHorizontal: 12,marginRight: 12,fontSize: 15,backgroundColor: '#f5f5f5',},
