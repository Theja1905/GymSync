...
const styles = StyleSheet.create({
  ...
  routineInput: { borderWidth: 1, borderColor: '#ccc', paddingVertical: 14, paddingHorizontal: 16, borderRadius: 8, marginBottom: 24, fontSize: 16, backgroundColor: '#fafafa' },
  card: { backgroundColor: '#fff', padding: 20, borderRadius: 16, borderWidth: 1, borderColor: '#ddd', marginBottom: 30 },
  headerRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 10, paddingHorizontal: 5 },
  headerTextExercise: { width: '50%', fontWeight: '600', fontSize: 16 },
  headerTextSmall: { width: '22%', fontWeight: '600', fontSize: 16, textAlign: 'center' },
  inputRow: { flexDirection: 'row', alignItems: 'center', marginTop: 10, paddingHorizontal: 5 },
  inputExercise: { width: '50%', borderWidth: 1, borderColor: '#ddd', borderRadius: 8, paddingVertical: 10, paddingHorizontal: 10, marginRight: 5, fontSize: 15, backgroundColor: '#f5f5f5' },
  inputSmall: { width: '22%', borderWidth: 1, borderColor: '#ddd', borderRadius: 8, paddingVertical: 10, paddingHorizontal: 10, marginRight: 3, fontSize: 15, backgroundColor: '#f5f5f5' },
  deleteButton: { paddingHorizontal: 8, paddingVertical: 10, justifyContent: 'center', alignItems: 'center' },
  deleteButtonText: { fontSize: 19, color: '#FF3B30', fontWeight: 'bold' },
  ...
  addButtonText: { fontSize: 13, fontWeight: '400', color: '#007AFF' },
